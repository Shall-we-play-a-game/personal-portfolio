            ...
            <section className='grid lg:grid-cols-2 grid-cols-1 gap-x-6 justify-items-center'>
              <div className='order-2 lg:order-none'>
                <h1 className='lg:text-5xl text-4xl lg:leading-tight basis-1/2 font-bold mb-8'>
                  I&apos;m <span className='text-green-600'>Ibrahim.</span> I
                  live in {data.location}, where I design the future.
                </h1>
                ...
                <ul>
                  <li>
                    <a
                      ...
                      className='flex items-center gap-x-2 hover:text-purple-400 duration-300 mb-8'
                    >
                  ...
                  <li>
                    <div className='flex items-center gap-x-2 hover:text-purple-400 duration-300'>
                      <BiArrowToBottom className='text-lg bg-green-500 rounded-full ' />
                      <h4>Scroll Down to unviel my expertise</h4>
                    </div>
                  </li>
                </ul>
              </div>
